...
class BoardABCD(YeSrDigitalBoard):
    ...
    channels = [
        ...
        YeSrDigitalChannel(loc=['C', 12], name='813 fm TTL', mode='auto', manual_output=False, invert=False),
        ...
        YeSrDigitalChannel(loc=['D', 0], name='Monitor scope TTL', mode='auto', manual_output=False, invert=False),
