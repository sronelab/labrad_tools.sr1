...
class BoardABCD(YeSrDigitalBoard):
    ...
    channels = [
        ...
        YeSrDigitalChannel(loc=['B', 4], name='BB Red AWG Trig', mode='auto', manual_output=False, invert=False),
        ...
        YeSrDigitalChannel(loc=['C', 7], name='NC17', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['C', 8], name='NC18', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['C', 9], name='NC19', mode='auto', manual_output=False, invert=False),
        YeSrDigitalChannel(loc=['C', 10], name='NC20', mode='auto', manual_output=False, invert=False),
